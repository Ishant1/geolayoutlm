...
class OcrEngine:
    ...
    def setup_ocr(self) -> None:
        self.engine = PaddleOCR(use_angle_cls=True, lang='en', det_lang='ml', show_log=False)
        self.engine_block = PaddleOCR(use_angle_cls=True, lang='en', det_lang=None, show_log=False)
